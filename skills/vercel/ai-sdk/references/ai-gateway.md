...
When multiple versions of a model exist, use the one with the highest version number (e.g., prefer `claude-sonnet-4.6` over `claude-sonnet-4` over `claude-3.5-sonnet`).
