...
user-invocable: true
when-to-use: 'Trigger on: write an essay; thesis statement; outline for paper; revise my draft; introduction paragraph; argumentative essay; discussion post; academic writing; reading response. Also /academic-writing.'
argument-hint: /academic-writing task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Structure and revise academic prose: thesis statements, outlines, paragraphs, introductions/conclusions, argument flow, and tone by…'
  host: grok-build
