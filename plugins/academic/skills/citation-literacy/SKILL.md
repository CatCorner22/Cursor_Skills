...
user-invocable: true
when-to-use: 'Trigger on: cite this; APA format; MLA citation; bibliography; works cited; reference list; in-text citation; Chicago style; how do I cite. Also /citation-literacy.'
argument-hint: /citation-literacy task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Format and check academic citations: APA 7, MLA 9, and Chicago (notes-bibliography), in-text vs bibliography, common mistakes, and when to…'
  host: grok-build
