...
user-invocable: true
when-to-use: 'Trigger on: provenance; chain of custody; audit trail; lineage. Also /chain-of-custody-provenance.'
argument-hint: /chain-of-custody-provenance task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Token- or block-level provenance: which inputs, tools, prompt sections, and turns produced each output segment'
  host: grok-build
