...
user-invocable: true
when-to-use: 'Trigger on: AI transferable skills; cross domain AI; hallucination gate; pipeline stage. Also /ai-transfer-ecosystem-primer.'
argument-hint: /ai-transfer-ecosystem-primer task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Router for the AI-transfer catalog (45 techniques, #1–50 with five merges) — gates, scaffolds, and pipeline stages'
  host: grok-build
