...
user-invocable: true
when-to-use: 'Trigger on: underwriting risk; pre-delivery risk; RED YELLOW GREEN gate. Also /underwriting-risk-gate.'
argument-hint: /underwriting-risk-gate task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Score GREEN/YELLOW/RED risk before delivery for medical, legal, or financial-advice asks; hold RED for review
  host: grok-build
