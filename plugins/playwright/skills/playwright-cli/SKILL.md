...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /playwright-cli.
argument-hint: /playwright-cli task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Automate browser interactions, test web pages and work with Playwright tests — the general-purpose Playwright skill for this repo (web…
  host: grok-build
