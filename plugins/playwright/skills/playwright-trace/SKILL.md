...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /playwright-trace.
argument-hint: /playwright-trace task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Inspect Playwright trace files from the command line — list actions, view requests, console, errors, snapshots and screenshots
  host: grok-build
