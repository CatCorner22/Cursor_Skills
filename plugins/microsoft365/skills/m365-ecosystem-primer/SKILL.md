...
user-invocable: true
when-to-use: 'Trigger on: microsoft 365; microsoft office; word document; excel spreadsheet; powerpoint; outlook; teams meeting; onedrive; Microsoft 365; Office 365. Also /m365-ecosystem-primer.'
argument-hint: /m365-ecosystem-primer task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Router for Microsoft 365 work in this library: Word documents, Excel workbooks, PowerPoint decks, Outlook email/calendar, Teams…'
  host: grok-build
