...
user-invocable: true
when-to-use: 'Trigger on: word document; microsoft word; format my essay; table of contents; track changes; word styles; Microsoft Word; .docx. Also /word-documents.'
argument-hint: /word-documents task
paths:
- '**/*.docx'
- '**/*.doc'
...
metadata:
  author: CatCorner22
  short-description: 'Create and format Microsoft Word documents: styles, headings, page layout, tables of contents, track changes, comments, mail merge basics,…'
  host: grok-build
