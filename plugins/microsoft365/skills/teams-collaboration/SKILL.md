...
user-invocable: true
when-to-use: 'Trigger on: microsoft teams; teams meeting; teams channel; group project teams; Microsoft Teams; Teams chat. Also /teams-collaboration.'
argument-hint: /teams-collaboration task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Collaborate in Microsoft Teams for school and work: channels, chat threads, meetings, screen share, file tabs, and group project norms'
  host: grok-build
