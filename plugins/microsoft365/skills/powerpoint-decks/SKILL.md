...
user-invocable: true
when-to-use: 'Trigger on: powerpoint; slide deck; presentation slides; speaker notes; pptx; Microsoft PowerPoint; .pptx. Also /powerpoint-decks.'
argument-hint: /powerpoint-decks task
paths:
- '**/*.pptx'
- '**/*.ppt'
...
metadata:
  author: CatCorner22
  short-description: 'Structure and design Microsoft PowerPoint presentations: slide layouts, master slides, visuals, speaker notes, animations restraint, and…'
  host: grok-build
