...
user-invocable: true
when-to-use: 'Trigger on: excel formula; spreadsheet; pivot table; excel chart; vlookup; microsoft excel; Microsoft Excel; .xlsx; XLOOKUP. Also /excel-workbooks.'
argument-hint: /excel-workbooks task
paths:
- '**/*.xlsx'
- '**/*.xls'
- '**/*.csv'
...
metadata:
  author: CatCorner22
  short-description: 'Build and debug Microsoft Excel workbooks: formulas, references, tables, charts, conditional formatting, basic pivot tables, and data…'
  host: grok-build
