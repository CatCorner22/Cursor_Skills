...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /make-pr-easy-to-review.
argument-hint: /make-pr-easy-to-review task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Prepare PRs for review by cleaning noisy history, improving PR descriptions, and adding reviewer guidance without changing code behavior
  host: grok-build
