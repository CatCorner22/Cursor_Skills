...
user-invocable: true
when-to-use: Use when the user pastes a GitHub PR URL and asks for a review, walkthrough, or summary, or says "review this PR".
argument-hint: /pr-review-canvas task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Generate an interactive PR review walkthrough as an HTML page
  host: grok-build
