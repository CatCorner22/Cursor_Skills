...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /fix-ci.
argument-hint: /fix-ci task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Find failing PR checks, inspect logs or external check links, and apply focused fixes
  host: grok-build
