...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /fix-merge-conflicts.
argument-hint: /fix-merge-conflicts task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Resolve merge conflicts non-interactively, validate build and tests, and finalize conflict resolution
  host: grok-build
