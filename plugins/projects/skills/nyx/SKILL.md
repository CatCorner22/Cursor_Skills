...
user-invocable: true
when-to-use: 'Trigger on: nyx; character bible; nyx scene; nyx reference. Also /nyx.'
argument-hint: /nyx task
paths:
- skills/projects/nyx/**
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Canonical character bible for Nyx, a recurring original character in this project — appearance, physique, tattoo map, personality, voice,…
  host: grok-build
