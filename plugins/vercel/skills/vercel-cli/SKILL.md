...
user-invocable: true
when-to-use: 'Trigger on: check deployment; check deploy; deployment status; deploy status; vercel logs; vercel metrics; deployment logs; deploy logs; vercel inspect; is it deployed. Also /vercel-cli.'
argument-hint: /vercel-cli task
paths:
- vercel.json
- vercel.ts
- .vercel/**
...
metadata:
  author: CatCorner22
  short-description: Vercel CLI expert guidance
  host: grok-build
