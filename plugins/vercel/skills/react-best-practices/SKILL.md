...
user-invocable: true
when-to-use: Use when optimizing React/Next.js components. This is not an accessibility linter.
argument-hint: /react-best-practices task
paths:
- src/components/**/*.tsx
- src/components/**/*.jsx
- app/components/**/*.tsx
...
metadata:
  author: CatCorner22
  short-description: React performance best-practices for TSX files — 64 Vercel rules across 8 impact tiers (waterfalls, bundle size, server/client fetching,…
  host: grok-build
