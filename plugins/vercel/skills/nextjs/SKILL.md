...
user-invocable: true
when-to-use: 'Trigger on: next.js; nextjs; app router; server component; server action; pages router; getserversideprops; use server. Also /nextjs.'
argument-hint: /nextjs task
paths:
- next.config.*
- next-env.d.ts
- app/**
...
metadata:
  author: CatCorner22
  short-description: Next.js App Router expert guidance
  host: grok-build
