...
user-invocable: true
when-to-use: 'Trigger on: vercel workflow; workflow sdk; workflow devkit; durable workflow; durable execution; durable function; durable pipeline; durable process; durable agent; durable chat. Also /workflow.'
...
metadata:
  author: CatCorner22
  short-description: Vercel Workflow SDK expert guidance
  host: grok-build
