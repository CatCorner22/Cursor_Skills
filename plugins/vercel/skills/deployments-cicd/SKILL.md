...
user-invocable: true
when-to-use: Use when deploying, promoting, rolling back, inspecting deployments, building with --prebuilt, or configuring CI workflow files for Vercel.
argument-hint: /deployments-cicd task
paths:
...
metadata:
  author: CatCorner22
  short-description: Vercel deployment and CI/CD expert guidance
  host: grok-build
