...
user-invocable: true
when-to-use: 'Trigger on: chat sdk; chat bot; chatbot; conversational interface; slack bot; telegram bot; discord bot; teams bot; onNewMention; onSubscribedMessage. Also /chat-sdk.'
argument-hint: /chat-sdk task
paths:
- app/api/chat/**
- app/api/chat-bot/**
- app/api/bot/**
...
metadata:
  author: CatCorner22
  short-description: Vercel Chat SDK expert guidance
  host: grok-build
