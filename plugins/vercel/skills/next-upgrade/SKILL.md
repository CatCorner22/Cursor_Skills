...
user-invocable: true
when-to-use: 'Trigger on: upgrade next; upgrade nextjs; migrate next; update next.js; next.js upgrade; nextjs migration; next codemod; breaking changes; codemod; migration guide. Also /next-upgrade.'
argument-hint: /next-upgrade task
paths:
- next.config.*
- package.json
...
metadata:
  author: CatCorner22
  short-description: Upgrade Next.js to the latest version following official migration guides and codemods
  host: grok-build
