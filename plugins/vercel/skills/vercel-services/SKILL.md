...
user-invocable: true
when-to-use: 'Trigger on: vercel services; vercel service binding; vercel service bindings; multi-service vercel; multiple services on vercel; frontend and backend on vercel; backend; monorepo; polyglot; service. Also /vercel-services.'
argument-hint: /vercel-services task
paths:
- vercel.json
- apps/*/vercel.json
...
metadata:
  author: CatCorner22
  short-description: Configure and troubleshoot Vercel Services for multiple frontends and backends in one project
  host: grok-build
