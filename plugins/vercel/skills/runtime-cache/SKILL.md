...
user-invocable: true
when-to-use: Use when implementing caching strategies beyond framework-level caching.
argument-hint: /runtime-cache task
paths:
- lib/cache/**
- src/lib/cache/**
- lib/cache.*
...
metadata:
  author: CatCorner22
  short-description: Vercel Runtime Cache API guidance — ephemeral per-region key-value cache with tag-based invalidation
  host: grok-build
