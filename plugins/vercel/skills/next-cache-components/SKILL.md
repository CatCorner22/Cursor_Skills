...
user-invocable: true
when-to-use: 'Trigger on: use cache; cache components; partial prerendering; PPR; cacheLife; cacheTag; updateTag; unstable_cache; revalidateTag; stale. Also /next-cache-components.'
argument-hint: /next-cache-components task
paths:
- next.config.*
- app/**
- src/app/**
...
metadata:
  author: CatCorner22
  short-description: Next.js 16 Cache Components guidance — PPR, use cache directive, cacheLife, cacheTag, updateTag, and migration from unstable_cache
  host: grok-build
