...
user-invocable: true
when-to-use: Use when choosing, configuring, or using data storage with Vercel applications.
argument-hint: /vercel-storage task
paths:
- lib/blob/**
- lib/storage/**
- src/lib/blob/**
...
metadata:
  author: CatCorner22
  short-description: Vercel storage expert guidance — Blob, Edge Config, and Marketplace storage (Neon Postgres, Upstash Redis)
  host: grok-build
