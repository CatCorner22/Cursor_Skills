...
user-invocable: true
when-to-use: 'Trigger on: websocket; websockets; web socket; socket.io; long polling; long-polling; realtime; bidirectional; ws server; polling. Also /vercel-functions.'
argument-hint: /vercel-functions task
paths:
- api/**/*.*
- pages/api/**
- src/pages/api/**
...
metadata:
  author: CatCorner22
  short-description: Vercel Functions expert guidance — Serverless Functions, Edge Functions, Fluid Compute, streaming, Cron Jobs, and runtime configuration
  host: grok-build
