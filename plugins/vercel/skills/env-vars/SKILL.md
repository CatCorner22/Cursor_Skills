...
user-invocable: true
when-to-use: Use when working with .env files, vercel env commands, OIDC tokens, or managing environment-specific configuration.
argument-hint: /env-vars task
paths:
- .env
- .env.*
- .env.local
...
metadata:
  author: CatCorner22
  short-description: Vercel environment variable expert guidance
  host: grok-build
