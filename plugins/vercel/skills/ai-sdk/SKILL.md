...
user-invocable: true
when-to-use: 'Trigger on: ai sdk; vercel ai; generatetext; streamtext; usechat; usecompletion; tool calling; embeddings. Also /ai-sdk.'
argument-hint: /ai-sdk task
paths:
- app/api/chat/**
- app/api/completion/**
- src/app/api/chat/**
...
metadata:
  author: CatCorner22
  short-description: Vercel AI SDK expert guidance
  host: grok-build
