...
user-invocable: true
when-to-use: Use when configuring model routing, provider failover, cost tracking, or managing multiple AI providers through a unified API.
argument-hint: /ai-gateway task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Vercel AI Gateway expert guidance
  host: grok-build
