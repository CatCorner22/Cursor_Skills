...
user-invocable: true
when-to-use: 'Trigger on: knowledge update; outdated knowledge; fluid compute; vercel.ts. Also /knowledge-update.'
argument-hint: /knowledge-update task
paths:
- vercel.ts
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Corrects outdated LLM knowledge about the Vercel platform and introduces new products
  host: grok-build
