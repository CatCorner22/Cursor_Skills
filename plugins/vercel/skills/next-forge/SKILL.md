...
user-invocable: true
when-to-use: 'Trigger on: next-forge; next forge; @repo/; saas starter; production monorepo; keys.ts; pnpm-workspace. Also /next-forge.'
argument-hint: /next-forge task
paths:
- pnpm-workspace.yaml
- apps/app/**
- apps/web/**
...
metadata:
  author: CatCorner22
  short-description: next-forge expert guidance — production-grade Turborepo monorepo SaaS starter by Vercel
  host: grok-build
