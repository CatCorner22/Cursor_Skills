...
user-invocable: true
when-to-use: use when the user asks about shared layouts across projects, navigation between microfrontends, fallback environments, asset prefixes, or feature flag controlled routing.
argument-hint: /microfrontends task
paths:
- microfrontends.json
...
metadata:
  author: CatCorner22
  short-description: Guide for building, configuring, and deploying microfrontends on Vercel
  host: grok-build
