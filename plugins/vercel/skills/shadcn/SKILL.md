...
user-invocable: true
when-to-use: Use when initializing shadcn, adding components, composing product UI, building custom registries, configuring themes, or troubleshooting component issues.
argument-hint: /shadcn task
paths:
- components.json
- components/ui/**
- src/components/ui/**
...
metadata:
  author: CatCorner22
  short-description: shadcn/ui expert guidance — CLI, component installation, composition patterns, custom registries, theming, Tailwind CSS integration, and…
  host: grok-build
