...
user-invocable: true
when-to-use: 'Trigger on: lecture notes; record class; study from recording; plaud lecture; exam prep from lecture; record lecture; professor lecture. Also /plaud-lecture-notes.'
argument-hint: /plaud-lecture-notes task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Turn Plaud lecture recordings into study materials: capture setup, summary templates for classes, Cornell-style refinement, exam prep…'
  host: grok-build
