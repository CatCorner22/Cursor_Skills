...
user-invocable: true
when-to-use: 'Trigger on: export plaud; plaud to word; mind map plaud; download transcript; export transcript; 27 formats. Also /plaud-export-integrate.'
argument-hint: /plaud-export-integrate task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Export Plaud transcripts and summaries to Word, PDF, mind maps, and integrate with OneDrive, Teams, Notion, or email workflows
  host: grok-build
