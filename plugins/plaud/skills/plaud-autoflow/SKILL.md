...
user-invocable: true
when-to-use: 'Trigger on: plaud autoflow; automatic transcription; auto summarize; email summary plaud; AutoFlow; auto generation. Also /plaud-autoflow.'
argument-hint: /plaud-autoflow task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Configure Plaud AutoFlow: automatic device-to-app transfer, auto-transcription, auto-summary with chosen template and LLM, and email…'
  host: grok-build
