...
user-invocable: true
when-to-use: 'Trigger on: start plaud recording; plaud note; record lecture; phone call recording; press to highlight; Plaud NotePin; dual mode. Also /plaud-recording-capture.'
argument-hint: /plaud-recording-capture task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Capture audio with Plaud devices and app: in-person vs phone-call mode, press-to-highlight, placement, battery, consent, and recording…'
  host: grok-build
