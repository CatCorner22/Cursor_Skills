...
user-invocable: true
when-to-use: 'Trigger on: test as you go; real time testing; real-time testing; while coding; TDD; red green refactor; watch mode; run tests after. Also /real-time-testing.'
argument-hint: /real-time-testing task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: 'Test code continuously while writing it: red-green-refactor, watch mode, typecheck and lint after every slice, and never report done…'
  host: grok-build
