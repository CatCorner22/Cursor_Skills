...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /appbuilder-ui-scaffolder.
argument-hint: /appbuilder-ui-scaffolder task
license: Apache-2.0
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Generate React Spectrum UI components for Adobe Experience Cloud Shell SPAs and AEM UI Extensions
  host: grok-build
