...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /appbuilder-cicd-pipeline.
argument-hint: /appbuilder-cicd-pipeline task
license: Apache-2.0
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Set up CI/CD pipelines for Adobe App Builder projects
  host: grok-build
