...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /appbuilder-action-scaffolder.
argument-hint: /appbuilder-action-scaffolder task
license: Apache-2.0
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Create, implement, deploy, and debug Adobe Runtime actions with consistent layout, validation, and error handling
  host: grok-build
