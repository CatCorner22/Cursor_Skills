...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /appbuilder-testing.
argument-hint: /appbuilder-testing task
license: Apache-2.0
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Generate and run tests for Adobe App Builder actions and UI components
  host: grok-build
