...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /transformers-js.
argument-hint: /transformers-js task
license: Apache-2.0
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Use Transformers.js to run state-of-the-art machine learning models directly in JavaScript/TypeScript
  host: grok-build
