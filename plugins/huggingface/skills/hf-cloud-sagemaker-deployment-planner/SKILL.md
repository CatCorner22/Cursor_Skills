...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /hf-cloud-sagemaker-deployment-planner.
argument-hint: /hf-cloud-sagemaker-deployment-planner task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Plan and coordinate the deployment of a model to Amazon SageMaker AI
  host: grok-build
