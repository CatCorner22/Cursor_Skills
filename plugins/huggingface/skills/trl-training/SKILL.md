...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /trl-training.
argument-hint: /trl-training task
license: Apache-2.0
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Train and fine-tune transformer language models locally with the TRL CLI (SFT, DPO, GRPO, KTO, RLOO, Reward Model)
  host: grok-build
