...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /hf-cloud-sagemaker-iam-preflight.
argument-hint: /hf-cloud-sagemaker-iam-preflight task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Ensure a usable SageMaker execution role exists before deploying or training
  host: grok-build
