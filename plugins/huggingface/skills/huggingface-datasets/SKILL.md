...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /huggingface-datasets.
argument-hint: /huggingface-datasets task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Use this skill for Hugging Face Dataset Viewer API workflows that fetch subset/split metadata, paginate rows, search text, apply filters,…
  host: grok-build
