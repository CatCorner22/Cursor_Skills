...
user-invocable: true
when-to-use: Use when the task matches this skill. Also /huggingface-paper-publisher.
argument-hint: /huggingface-paper-publisher task
compatibility: Grok Build (CLI, TUI, IDE). Also readable as Agent Skills / AGENTS.md.
metadata:
  author: CatCorner22
  short-description: Publish and manage research papers on Hugging Face Hub
  host: grok-build
