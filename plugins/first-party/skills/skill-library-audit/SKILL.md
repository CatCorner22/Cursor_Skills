...
user-invocable: true
when-to-use: 'Trigger on: audit the skill library; skill routing; trigger collision; vendor steering; skills fire on the wrong; overlay drift; why did that skill trigger; overlay.yaml; chainTo; promptSignals. Also /skill-library-audit.'
argument-hint: /skill-library-audit task
paths:
- '**/SKILL.md'
- '**/overlay.yaml'
- .cursor/skills/**
...
metadata:
  author: CatCorner22
  short-description: Audit a multi-vendor agent-skill library for routing pathology — the defect classes that appear only when many packs from different…
  host: grok-build
