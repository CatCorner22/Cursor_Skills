...
- **Snapshot:** [skills/](skills/) — 89 `SKILL.md` files (Cursor Cloud, Vercel, Hugging Face, Adobe, Supabase, Cursor Team Kit, Playwright, Cursor SDK, plus one first-party skill authored here). Provenance in [skills/SOURCE.md](skills/SOURCE.md).
