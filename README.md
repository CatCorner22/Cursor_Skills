...
- **Snapshot:** [skills/](skills/) — 72 `SKILL.md` files (Cursor Cloud, Vercel, Hugging Face, Adobe, Supabase, Cursor Team Kit). Provenance in [skills/SOURCE.md](skills/SOURCE.md).
